;(function(){
  ...
  Panel.prototype.bind = function(){
    ...
    r.querySelector('#qnp-section').addEventListener('change', (e)=> {
  ...
  Panel.prototype.goToSection = function(sectionId){
    if (!sectionId) return;
    const el = document.getElementById(sectionId);
    if (!el) { try { history.replaceState(null, '', '#'+sectionId); } catch(e){} return; }
